// MemoryManager
// Class used to keep track of jobs in a virtual
// free space table of 100 slots
...
class MemoryManager {
private:
    long mem[100];  // mem array works as the memory table. 
                    // Each new job added to memory has its size put
                    // in the array location that it was swapped in
